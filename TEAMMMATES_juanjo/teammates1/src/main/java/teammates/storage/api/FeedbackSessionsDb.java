...
public class FeedbackSessionsDb extends EntitiesDb {
    ...
    public List<FeedbackSessionAttributes> get_open(Date fecha) throws ParseException
    {
        List<FeedbackSessionAttributes> lista_session=getAllFeedbackSessions();
        List<FeedbackSessionAttributes> resultado=new ArrayList<FeedbackSessionAttributes>();
        //List<String> resul=new ArrayList<String>();
       for(FeedbackSessionAttributes temp:lista_session)
        {
            SimpleDateFormat formato = new SimpleDateFormat("yyy-MM-dd HH:mm:ss");
           // String palabra=formato.format(conver);
            //java.util.Date real=new Date(palabra);
           // SimpleDateFormat formato = new SimpleDateFormat("yyy-M-dd HH:mm:ss");
            String pala=formato.format(temp.endTime);
            Date conver1=formato.parse(pala);
           // resul.add(pala);
            if(conver1.compareTo(fecha)==0)
            {
                resultado.add(temp);
            }
    ...
    public List<FeedbackSessionAttributes> get_start(Date fecha) throws ParseException
    {
        List<FeedbackSessionAttributes> lista_session=getAllFeedbackSessions();
        List<FeedbackSessionAttributes> resultado=new ArrayList<FeedbackSessionAttributes>();
        //List<String> resul=new ArrayList<String>();
       for(FeedbackSessionAttributes temp:lista_session)
        {
           ...
           // String palabra=formato.format(conver);
            //java.util.Date real=new Date(palabra);
           // SimpleDateFormat formato = new SimpleDateFormat("yyy-M-dd HH:mm:ss");
            String pala=formato.format(temp.startTime);
            Date conver1=formato.parse(pala);
           // resul.add(pala);
            if(conver1.compareTo(fecha)==0)
            {
